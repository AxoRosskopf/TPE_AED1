...
\aux{cantidadDeMinasJugadas}{t:tablero, j:jugadas}{\ent}{\sum_{i=0}^{|j|-1} {\IfThenElse{(t[(j[i]_0)_0][j[i]_0)_1] = true}{1}{0}}}
...
\pred{repiteJugada}{j:jugadas}{	(\forall i : \ent)( (0 \leq i < |j|) \implicaLuego (\exists k: \ent) ((0 \leq k \leq |j|)
    \y (i\neq k)) \yLuego ((j[i]_0)_0 = (j[k]_0)_0 \y (j[i]_0)_1 = (j[k]_0)_1 )}{}
...
\pred{juegoValido}{t: tablero, j: jugadas}{(\forall i : \ent)( (0 \leq i < |j|) $\implicaLuego$ (posicionEsValida(j[i]_0) \bigwedge ($j[i]_1$ = minasAdyacentes (t, j[0]_0)) \bigwedge  $\neg$ repiteJugada(j) \bigwedge \\($0\leq cantidadDeMinas(t, j) \leq 1)$)} {}
